...
def catalog_courses():
    ...
    try:
        ...
        catalog_html = catalog_table.to_html(index=False, classes=['table', 'table-bordered'], na_rep='')
...
def get_info():
    ...
    try:
        ...
        bad_df_html = bad_df.to_html(index=False, classes=['table', 'table-bordered', 'table-striped'],
                                     na_rep='')
